...
const HomePage = () => {
    return (
        <div className="mx-4 md:mx-auto md:max-w-screen-md lg:max-w-screen-lg">
            ...
            <div className="text-center">
                <input
                    ...
                    className="input input-bordered bg-gray-500 my-7 text-center md:w-[400px] w-[300px] md:h-[200px] h-[100px]"
                />
            </div>
