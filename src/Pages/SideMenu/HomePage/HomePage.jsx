...
const HomePage = () => {
  ...
  return (
    <div
      className="home-container hero min-h-screen"
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="md:mx-auto md:max-w-screen-md lg:max-w-screen-lg fixe ">
          ...
          <div className="flex flex-col px-4 md:p-0 md:flex-row justify-center gap-2 md:gap-4 my-4">
            ...
            >
              <SiGooglesheets className="mr-2" /> <Link>New Project</Link>
            </button>
          ...
          >
            <input
              ...
              className="input input-bordered bg-gray-200 my-7 text-center md:w-[400px] w-auto md:h-[150px] h-[100px] border-cyan-500"
            />
          </div>
